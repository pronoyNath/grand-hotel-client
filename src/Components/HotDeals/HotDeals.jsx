const HotDeals = () => {
    return (
        <div className="relative h-[500px] my-10 object-cover" style={{ backgroundImage: 'url(https://th.bing.com/th/id/R.eef7a82b95e6894e06e0afb908147736?rik=EhwReJ48HH7P3w&pid=ImgRaw&r=0)' }}>
