    ...
    return (
        <div>
            <div className="py-16 text-center max-w-6xl mx-auto">
                <h3 className="font-semibold text-lg md:text-4xl mb-5 text-center">Our Best Deal</h3>
            ...
            <div className="relative h-[500px] object-cover" style={{ backgroundImage: 'url(https://th.bing.com/th/id/R.eef7a82b95e6894e06e0afb908147736?rik=EhwReJ48HH7P3w&pid=ImgRaw&r=0)' }}>
                <div className="absolute overflow-x-hidden rounded-lg w-full h-full bg-gradient-to-r from-black to-[#dbb878] opacity-30"></div>
                <div className="md:flex gap-64 justify-center items-center max-w-6xl mx-auto h-full">
                    <div className="lg:flex flex-col hidden  justify-center text-white h-full">
                    ...
                    <div>
                        <div className="w-[300px] h-[300px] relative bg-yellow-300 rounded-full mb-10 ml-10 lg:ml-0">
