  ...
  return (
    ...
    <form onSubmit={handleReview} method="dialog" className="flex flex-col p-6 space-y-6 md:py-0 md:px-6">
      <label className="block">
        ...
        <input type="text" name='username' placeholder="user name" className="block w-full rounded-md shadow-sm focus:ring border p-2 border-[#dbb878] focus:ri focus:ri dark:bg-gray-800" required/>
      </label>
      ...
      <label className="block">
        ...
        <textarea rows="3" name='comment' className="block w-full rounded-md focus:ring focus:ri focus:ri dark:bg-gray-800 border p-2 border-[#dbb878]" required></textarea>
      </label>
